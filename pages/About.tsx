...
const AboutPage: React.FC = () => {
  ...
  return (
    <div>
      <Head>
        <title> KOBE Pann | 中秋禮盒預購網 | 聯絡我們 | 關於我們</title>
        <meta
          name="description"
          content={`今年蛋黃酥3.0
          更酥鬆的餅皮 及 綿密細緻的鹹鴨蛋
      ...
      <Layout>
        ...
        <div className="container">
          <section className="section visible" id="about">
            ...
            <p>
              在繁忙的城市生活中，總有一個地方讓人想起家的溫暖，那就是KOBE
              PANN。這家麵包店的名字蘊含著深意，&quot;KOBE&quot;這個詞源自日文發音，與中文的&quot;口碑&quot;有相似之處，象徵著我們追求卓越品質和顧客的良好評價。&quot;PANN&quot;則是台語中&quot;麵包&quot;的諧音，簡單卻溫馨，讓人感受到家的味道。
              KOBE
              PANN的創立源於一個樸素而真摯的夢想：將日式、台式和歐式麵包的精髓結合在一起，為每一位顧客帶來最純正的味覺享受。我們的創始人在一次日本旅行中，深深被當地麵包的香氣和口感所吸引，回到台灣後，他決心創立一家能夠融合世界各地麵包特色的麵包店。
            </p>
          </section>
          ...
          <section className="section visible" id="values">
            ...
            <div className="grid">
              <div className="card">
                <img
                  src="/kobe/879F7042-B361-4EB0-B9C3-F127348A3A20.jpeg"
                  alt="品質保證"
                />
                <h3>品質保證</h3>
              ...
              <div className="card">
                ...
                <h3>創新精神</h3>
                <p>
                  傳統工藝結合現代技術，不斷推陳出新，滿足顧客多元化的需求。
                </p>
              </div>
              <div className="card">
                <img
                  src="/kobe/EC2AAE47-B8E4-488A-A6FA-D7177B0366E0.jpeg"
                  alt="優質服務"
                />
                <h3>明亮舒適</h3>
                <p>
                  乾淨明亮的展示空間，提供舒適的選物環境，讓您在這裡能夠輕鬆愉快地選擇。
                </p>
              </div>
            </div>
          </section>
